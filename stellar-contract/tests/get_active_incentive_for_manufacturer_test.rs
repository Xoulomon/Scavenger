...
fn test_get_active_incentive_multiple_manufacturers_isolation() {
    ...
    client.register_participant(&manufacturer1, &ParticipantRole::Manufacturer, &soroban_sdk::symbol_short!("name"), &0, &0);
    client.register_participant(&manufacturer2, &ParticipantRole::Manufacturer, &soroban_sdk::symbol_short!("name"), &0, &0);
    client.register_participant(&manufacturer3, &ParticipantRole::Manufacturer, &soroban_sdk::symbol_short!("name"), &0, &0);
    ...
    assert_eq!(r1.reward_points, 50);
    assert_eq!(r1.rewarder, manufacturer1);
    
    let r2 = result2.unwrap();
    assert_eq!(r2.reward_points, 90);
    assert_eq!(r2.rewarder, manufacturer2);
    
    let r3 = result3.unwrap();
    assert_eq!(r3.reward_points, 60);
    assert_eq!(r3.rewarder, manufacturer3);
}
