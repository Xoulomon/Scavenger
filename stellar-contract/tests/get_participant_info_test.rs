...
fn test_get_participant_info_returns_participant_and_stats() {
    ...
    client.register_participant(&user, &ParticipantRole::Collector, &soroban_sdk::symbol_short!("name"), &0, &0);
...
fn test_get_participant_info_preserves_registration_time() {
    ...
    // Register participant
    let participant = client.register_participant(&user, &ParticipantRole::Collector, &soroban_sdk::symbol_short!("name"), &0, &0);
...
fn test_get_participant_info_multiple_participants() {
    ...
    client.register_participant(&user1, &ParticipantRole::Collector, &soroban_sdk::symbol_short!("name"), &0, &0);
    client.register_participant(&user2, &ParticipantRole::Recycler, &soroban_sdk::symbol_short!("name"), &0, &0);
