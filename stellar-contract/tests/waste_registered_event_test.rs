...
//     client.register_participant(&recycler1, &ParticipantRole::Recycler, &soroban_sdk::symbol_short!("name"), &0, &0);
//     client.register_participant(&recycler2, &ParticipantRole::Recycler, &soroban_sdk::symbol_short!("name"), &0, &0);
...
//     // let all_events = env.events().iter();
